...
%     PLACE AND DATE: <Genoa, March 2022>
    ...
    methods (Access = protected)
        ...
        function setupImpl(obj)
            ...
            obj.contacts = mwbs.Contacts(obj.contact_config.foot_print, obj.robot.NDOF, obj.contact_config.friction_coefficient, obj.contact_config.num_in_contact_frames, obj.contact_config.num_vertices, obj.physics_config.TIME_STEP, obj.ifFieldExists('contact_config','max_consecutive_failures'), obj.ifFieldExists('contact_config','useFrictionalImpact'), obj.ifFieldExists('contact_config','useDiscreteContact'), obj.ifFieldExists('contact_config','useCircularFeet'));
